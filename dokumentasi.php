<?php
    ...
    if (isset($_GET["studi"])){
        foreach ($datadokumentasi as $a){
            $pattern = "/{$_GET["studi"]}/i";
            if (preg_match_all($pattern, $a->studi)) $search = $a;
        }
    }
    if($search) $datadokumentasi = $search;
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <section id="studi">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="section-description">Berikut adalah berkas dokumentasi seputar <b><?=$datadokumentasi->studi?></b> pada Fakultas Sains Dan Informatika UNJANI Cimahi</p>
                    </div>
                  </div>
                </div>
                <div class="container studi-container" data-aos="fade-up" data-aos-delay="200">
                  <div class="row">      
                    <div class="col-lg-6 studi-img">
                        <img src="<?=$datadokumentasi->konten?>"> <br><br>
                        <img src="<?=$datadokumentasi->konten2?>"> <br><br>
                        <img src="<?=$datadokumentasi->konten4?>">
                    </div>
                    <div class="col-md-6 about-content">
                        <div class="col-lg-11 studi-img">
                            <img src="<?=$datadokumentasi->konten1?>"> <br><br>
                            <img src="<?=$datadokumentasi->konten3?>"> <br><br>
                            <img src="<?=$datadokumentasi->konten5?>"> 
                        </div>
            </div>
            </div>
        </section>
