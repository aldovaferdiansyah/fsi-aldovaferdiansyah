<?php   
    ...
    $register=json_decode(file_get_contents("JSON/hmjif.json")); 
    $data = [
        "nama" => $_POST["nama"],
        "email" => $_POST["email"],
    ...
    $strem = fopen("JSON/hmjif.json", "w");
    fwrite($strem, json_encode($register));
    header("location: loginhmjif.php");
    }
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        ...
        <div class="row">
          <div class="col-md-12">
            <h3 class="section-title">Register HM KMJ IF FSI Unjani</h3>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
              ...
              <div class="tambahan">
                Sudah Punya Akun ?
                <a href="loginhmjif.php"><b> Login Di Sini </b></a>
              </div>
            </div>
          </div>
        </div>
