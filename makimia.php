        ...
        <section id="studi">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="section-description">Berikut adalah penjelasan sekaligus pengenalan seputar Studi Magister Kimia pada Fakultas Sains Dan Informatika UNJANI Cimahi</p>
                    </div>
                  </div>
                </div>
                <div class="container studi-container" data-aos="fade-up" data-aos-delay="200">
                  <div class="row">      
                    ...
                    <h2 class="studi-title">Studi Magister Kimia S2</h2>
                    <p class="studi-text">
                    ...
                    if($foto->studi=="Studi Magister Kimia"):
                    ?>
                    <form action="dokumentasi.php">
                        <input type="hidden" name="studi" value="<?=$foto->studi?>">
                        <button type="text">Dokumentasi Studi Magister Kimia Unjani</button>
                    </form>
                    <?php
                    endif;
                    endforeach;
