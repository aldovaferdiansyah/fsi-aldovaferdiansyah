...
<body>
    ...
    <header id="header_ormawa" class="d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            ...
            <li><a class="nav-link scrollto" href="https://www.instagram.com/himakaunjani/">Sosial Media</a></li>
        ...
        <section id="studi">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="section-title">HIMAKA Unjani</h3>
                    <div class="section-title-divider"></div>
                    <p class="section-description">Berikut adalah penjelasan sekaligus pengenalan seputar HIMAKA pada Fakultas Sains Dan Informatika UNJANI Cimahi</p>
                    </div>
                  </div>
                </div>
                <div class="container studi-container" data-aos="fade-up" data-aos-delay="200">
                  <div class="row">      
                    <div class="col-lg-6 studi-img">
                        <img src="Gambar/HIMAKA.png">
                    </div>
                    <div class="col-md-6 about-content">
                    <h2 class="studi-title">Himpunan Mahasiswa Kimia Unjani</h2>
                    <p class="studi-text">
