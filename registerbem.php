<?php   
    ...
    $register=json_decode(file_get_contents("JSON/bem.json")); 
    $data = [
        "nama" => $_POST["nama"],
        "email" => $_POST["email"],
    ...
    $strem = fopen("JSON/bem.json", "w");
    fwrite($strem, json_encode($register));
    header("location: loginbem.php");
    }
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        ...
        <div class="row">
          <div class="col-md-12">
            <h3 class="section-title">Register BEM FSI Unjani</h3>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
              ...
              <div class="tambahan">
                Sudah Punya Akun ?
                <a href="loginbem.php"><b> Login Di Sini </b></a>
              </div>
            </div>
          </div>
        </div>
