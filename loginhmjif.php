<?php
    session_start();
    $login=json_decode(file_get_contents("JSON/hmjif.json"));
    if(isset($_POST["login"])) {
        ...
        if($user){
            if($_POST["email"] == $user->email && $_POST["password"] == $user->password){
                ...
                header('location:halamanhmjif.php');
            }else{
                header("location:loginhmjif.php?pesan=gagal");
            }
        }else{
            header("location:loginhmjif.php?pesan=gagal");
        }
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
            ...
            <li class="dropdown"><a class="nav-link scrollto active" href="#"><span>Kemahasiswaan</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                    ...
                    <ul>
                        ...
                        <li><a href="#">HM KMJ IF Unjani</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <h3 class="section-title">Login HM KMJ IF FSI Unjani</h3>
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
              ...
              <div class="tambahan">
                ...
                <a href="registerhmjif.php"><b> Register Di Sini </b></a>
              </div>
            </div>
          </div>
        </div>
