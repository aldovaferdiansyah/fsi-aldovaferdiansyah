<?php
    session_start();
    $login=json_decode(file_get_contents("JSON/himaka.json"));
    if(isset($_POST["login"])) {
        ...
        if($user){
            if($_POST["email"] == $user->email && $_POST["password"] == $user->password){
                ...
                header('location:halamanhimaka.php');
            }else{
                header("location:loginhimaka.php?pesan=gagal");
            }
        }else{
            header("location:loginhimaka.php?pesan=gagal");
        }
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        ...
        <div class="row">
          <div class="col-md-12">
            <h3 class="section-title">Login HIMAKA FSI Unjani</h3>
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
              ...
              <div class="tambahan">
                ...
                <a href="registerhimaka.php"><b> Register Di Sini </b></a>
              </div>
            </div>
          </div>
        </div>
